...
from src.model import NLPModel
...
if query:
    ...
    for sugg in suggestions:
        ...
        with col1:
            st.image(f'https://i.ytimg.com/vi/{sugg.video_id}/default.jpg', width=100)
        with col2:
            st.markdown(f'[{sugg.title}](https://www.youtube.com/watch?v={sugg.video_id})', unsafe_allow_html=True)
